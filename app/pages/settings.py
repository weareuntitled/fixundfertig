...
def render_settings(session, comp: Company) -> None:
    ...
    with ui.card().classes(C_CARD + " p-6 w-full"):
        ...
        default_sender_email = ui.input("Standard-Absender", value=comp.default_sender_email).classes(C_INPUT)
        ...
        n8n_secret = ui.input("n8n Secret Token", value=comp.n8n_secret).classes(C_INPUT)
