...
C_CARD_GLASS = "bg-white/70 border border-white/40 rounded-xl shadow-sm backdrop-blur"
C_CARD_GLASS_HOVER = "hover:border-white/60 hover:shadow-md hover:-translate-y-0.5"
